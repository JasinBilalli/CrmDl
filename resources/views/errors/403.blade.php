...
<div id="container">
    ...
    <h3 style="color: rgb(83, 133, 145)">Benutzer hat nicht die richtigen Rollen.</h3>
    <span style="color: #ffffff"><a style="color: #0a53be" href="{{URL::previous()}}">Click Me</a> To Go Back</span>
