<html>
<link href="css/confirm_sms.css" rel="stylesheet">
...
<div class="test">
    <form action="{{route('confirmsms')}}" method="post">
        ...
        <div class="tel my-5">
            <div class="my-3 lh-1">
            <span class="spn1">Telefonnnumer</span><br>
            ...
            <button type="submit" class="continuebtn">Weiter <i class="bi bi-arrow-right ps-1"></i></button>
            </div>
            </div>
    </form>
</div>
