                            ...
                            <div class="info-divv px-2 my-3">
                                <div class="row">
                                    <div class="col-12 col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-4">
                                        ...
                                        <div class="white-thingy my-2">
                                            <div class="text-div py-3 ps-2">
                                                <span class="fw-600 ">Vorname:</span> <span class="fs-6">{{$app->first_name}} </span>
                                            </div>
                                        </div>
                                        <div class="white-thingy my-2">
                                            <div class="text-div py-3 ps-2">
                                                <span class="fw-600 ">Nachname:</span> <span class="fs-6">{{$app->last_name}}</span>
                                            </div>
                                        </div>
                                        <div class="white-thingy my-2">
                                            <div class="text-div py-3 ps-2">
                                    ...
                                    <div class="col-12 col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-4">
                                        <div class="white-thingy my-2">
                                            <div class="text-div py-3 ps-2">
                                                <span class="fw-600 ">Nr:</span> <span class="fs-6">{{$app->nr}}</span>
                                            </div>
                                        </div>
                                        <div class="white-thingy my-2">
                                            <div class="text-div py-3 ps-2">
                        ...
                        <form action="{{route('completeapp',$appId)}}" method="post">
                            ...
                            <div class="mx-3">
                                <button type="submit" class="w-100 sub-btn bg-white py-2 border-0 ">
                                    <span class="fw-bold fs-6 text-black">Einreichen</span>
                                </button>
                            </div>
                        </form>
                    </div>
