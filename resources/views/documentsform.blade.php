                ...
                Auth::guard('admins')->user()->hasRole('admin'))
                    ...
                    @else
                        <a href="{{route('calendar')}}"
                           class="nav-link  {{ (request()->is('calendar')) ? 'activeClassNav__' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff"
                                 class="bi bi-calendar-check" viewBox="0 0 16 16">
                                <path
                                    d="M10.854 7.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 9.793l2.646-2.647a.5.5 0 0 1 .708 0z"/>
...
@endphp
<form action="{{route('createLeadDataKK',['leadIdd'=> $leadleadid ,'personIdd' => $personId])}}" method="post"
                                    ...
                                    <div class="accordion accordion-flush" id="accordionFlushExample2">
                                        <div class="accordion-item">
                                            ...
                                            <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body" id="shtonew"
                                                     style="background-color: #EFEFEF !important; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
                                                    <div class="">
                                                        <div class="row">
                                                            <div
                                                        ...
                                                        <div class="my-3">
                                                            <div class="row">
                                                                ...
                                                                <input type="radio" class="btn-check"
                                                                       ...
                                                                       id="btnradio3abcdef" autocomplete="off" checked>
                                                                <label class="btn btn-outline-secondary"
                                                                       for="btnradio3abcdef">Ja</label>

                                                                <input type="radio" class="btn-check"
                                                                       name="accident_coverage" value="Nein"
                                                                       id="btnradio4abcdef" autocomplete="off">
                                                                <label class="btn btn-outline-secondary"
                                                                       for="btnradio4abcdef">Nein</label>
                                                            </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col">
                                                                 ...
                                                                 aria-label="Basic radio toggle button group">
                                                                <input type="radio" class="btn-check"
                                                                       name="traffic_legal_protection" value="Ja"
                                                                       id="btnradio3a" autocomplete="off" checked>
                                                                <label class="btn btn-outline-secondary"
                                                                       for="btnradio3a">Ja</label>

                                                                <input type="radio" class="btn-check"
                                                                       name="traffic_legal_protection" value="Nein"
                                                                       id="btnradio4a" autocomplete="off">
                                                                <label class="btn btn-outline-secondary"
                                                                ...
                                                                <input type="radio" class="btn-check"
                                                                       name="grossly" value="Nein"
                                                                       id="btnradio4ab" autocomplete="off">
                                                                <label class="btn btn-outline-secondary"
                                                                ...
                                                                <input type="radio" class="btn-check"
                                                                       name="glass_protection" value="Nein"
                                                                       id="btnradio4abc" autocomplete="off">
                                                                <label class="btn btn-outline-secondary"
                                                                       for="btnradio4abc">Nein</label>
                                                            </div>
                                                                    </div>
                                                                    <div class="input-div1 mb-2">
                                                                        <div class="">
                                                                ...
                                                                <input type="radio" class="btn-check"
                                                                       ...
                                                                       id="btnradio3abcd" autocomplete="off" checked>
                                                                <label class="btn btn-outline-secondary"
                                                                       for="btnradio3abcd">Ja</label>

                                                                <input type="radio" class="btn-check"
                                                                       name="parking_damage" value="Nein"
                                                                       id="btnradio4abcd" autocomplete="off">
                                                                <label class="btn btn-outline-secondary"
                                                                 ...
                                                                 aria-label="Basic radio toggle button group">
                                                                <input type="radio" class="btn-check"
                                                                       name="hour_breakdown_assistance" value="Ja"
                                                                       id="btnradio3abcde" autocomplete="off" checked>
                                                                <label class="btn btn-outline-secondary"
                                                                       for="btnradio3abcde">Ja</label>

                                                                <input type="radio" class="btn-check"
                                                                       name="hour_breakdown_assistance" value="Nein"
                                                                       id="btnradio4abcde" autocomplete="off">
                                                                <label class="btn btn-outline-secondary"
                                                        ...
                                                        <g id="Group_453" data-name="Group 453"
                                                           transform="translate(0.004)">
                                                            <line id="Line_16" data-name="Line 16" x2="51.954"
                                                                  y2="0.2" transform="translate(0 9.287)" fill="none"
                                                                  stroke="#3fd599" stroke-width="2" />
                                                            <path id="Polygon_2" data-name="Polygon 2"
                                                                  d="M9.58,0l9.58,11.642H0Z"
                                                                  transform="translate(58.151 0) rotate(90)"
...
'                                                                       class="form-label"'+
'                                                                       style="font-size: 13px;">Kommentar</label>'+
'                                                                <textarea name="commentFahrenzug' + newgcnt + '"' +
'                                                                          id="exampleFormControlTextarea1"'+
