                ...
                <form action="{{route('edit_costumer_kundportfolio',$costumerId)}}" method="POST">
                    ...
                    <div class="tab-content mx-2 mx-sm-4 pb-3" id="nav-tabContent">
                        <div class="tab-pane show active fade status-content mb-3" id="nav-home" role="tabpanel"
                            ...
                            <div class="row mx-2 mx-sm-4">
                                <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 mt-2 mb-0 my-sm-3">
                                            ...
                                            <div class="accordion-item"
                                                ...
                                                <h2 class="accordion-header" id="flush-heading0001">
                                                    <button class="accordion-button collapsed" type="button"
                                                            data-bs-toggle="collapse" data-bs-target="#flush-collapse0001"
                                                            ...
                                                            <div class="accordion-body"
                                                                ...
                                                                <div class="mb-3">
                                                                    <div class="input-div1 input-groupp justify-content-between">
                                                                        ...
                                                                        <input class="py-1 form-control " type="text" name="societyG{{$count}}" id="" readonly value="{{$grundversicherungPP->society_PG}}">
                                                                    </div>
                                                                ...
                                                                <div class="mb-3">
                                                                    <div class="input-div1 input-groupp justify-content-between">
                                                                        ...
                                                                        <input class="py-1 form-control " type="number" name="kvg_premiumG{{$count}}" readonly value="" id="">
                                                                    </div>
                                                                ...
                                                                <div class="mb-3">
                                                                    <div class="input-div1 input-groupp justify-content-between">
                                                                        ...
                                                                        <select class="form-select"  disabled aria-label="Default select example" name="statusG{{$count}}">
                                                                            <option selected >{{$grundversicherungPP->status_PG}}</option>
        ...
        {{--                                                                    <option value="Provisionert">Provisionert </option>--}}
                                                                ...
                                                                <div class="mb-3">
                                                                    <div class="input-div1 input-groupp justify-content-between">
                                                                        ...
                                                                        <input class="py-1 form-control" readonly value="{{$grundversicherungPP->last_adjustment_PG}}" type="date" name="modification_dateG{{$count}}" id="" min="1900-01-01" max="9999-12-31">
                                                                    </div>
                                                                ...
                                                                <div class="mb-3">
                                                                    <div class="input-div1 input-groupp justify-content-between">
                                                                        ...
                                                                        <input class="py-1 form-control " readonly value="{{$grundversicherungPP->total_commisions_PG}}" type="text" name="provisionG{{$count}}" id="">
                                                                    </div>
                                                                ...
                                                                <div class="mb-3">
                                                                    <div class="input-div1 input-groupp justify-content-between">
                                                                        ...
                                                                        <input class="py-1 form-control" readonly value="" type="text" name="cidG{{$count}}" id="">
                                                                    </div>
                                        ...
                                        <div class="accordion accordion-flush" id="accordionFlushExample0004">
                                            <div class="accordion-item"
                                                ...
                                                <h2 class="accordion-header" id="flush-heading0004">
                                                    <button class="accordion-button collapsed" type="button"
                                                            data-bs-toggle="collapse" data-bs-target="#flush-collapse0004"
                                                            aria-expanded="false" aria-controls="flush-collapseOne"
                                                            style="background-color: #EFEFEF !important; border-radius: 10px;">
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " readonly value="{{$vorsorgeP->society_PV}}" type="text" name="societyV" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " readonly value="" type="number" name="productionV" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <select class="form-select" disabled aria-label="Default select example" name="statusV">
...
{{--                                                                    <option value="Provisionert">Provisionert </option>--}}
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " readonly value="{{$vorsorgeP->last_adjustment_PV}}" type="date" name="modification_dateV" id="" min="1900-01-01" max="9999-12-31">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " readonly value="{{$vorsorgeP->total_commisions_PV}}" type="text" name="provisionV" id="">
                                                            </div>
                                        ...
                                        <div class="accordion accordion-flush" id="accordionFlushExample0002">
                                            <div class="accordion-item"
                                                ...
                                                <h2 class="accordion-header" id="flush-heading0002">
                                                    <button class="accordion-button collapsed" type="button"
                                                            data-bs-toggle="collapse" data-bs-target="#flush-collapse0002"
                                                            aria-expanded="false" aria-controls="flush-collapseOne"
                                                            style="background-color: #EFEFEF !important; border-radius: 10px;">
                                                ...
                                                @foreach($zusatzversicherungP as $zusatzversicherungPP)
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " readonly value="{{$zusatzversicherungPP->society_PZ}}" type="text" name="societyZ" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " readonly value="" type="number" name="vvg_premiumZ" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <select class="form-select" disabled aria-label="Default select example" name="statusZ">
...
{{--                                                                    <option value="Provisionert">Provisionert </option>--}}
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " readonly value="{{$zusatzversicherungPP->last_adjustment_PZ}}" type="date"  min="1900-01-01" max="9999-12-31" name="modification_dateZ" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " readonly value="{{$zusatzversicherungPP->total_commisions_PZ}}" type="text" name="provisionZ" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " readonly value="" type="text" name="cidZ" id="">
                                                            </div>
                                        ...
                                        <div class="accordion accordion-flush" id="accordionFlushExample0005">
                                            <div class="accordion-item"
                                                ...
                                                <h2 class="accordion-header" id="flush-heading0005">
                                                    <button class="accordion-button collapsed" type="button"
                                                            data-bs-toggle="collapse" data-bs-target="#flush-collapse0005"
                                                            aria-expanded="false" aria-controls="flush-collapseOne"
                                                            style="background-color: #EFEFEF !important; border-radius: 10px;">
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " readonly value="{{$hausratP->society_PH}}" type="text" name="societyH" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " readonly value="" type="number" name="kvg_premiumH" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <select class="form-select" disabled aria-label="Default select example" name="statusH">
...
{{--                                                                    <option value="Provisionert">Provisionert </option>--}}
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " readonly value="{{$hausratP->last_adjustment_PH}}" type="date" name="modification_dateH" id="" min="1900-01-01" max="9999-12-31">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " readonly value="{{$hausratP->total_commisions_PH}}" type="text" name="provisionH" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " readonly value="" type="text" name="cidH" id="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="accordion accordion-flush" id="accordionFlushExample0003">
                                            <div class="accordion-item"
                                                ...
                                                <h2 class="accordion-header" id="flush-heading0003">
                                                    <button class="accordion-button collapsed" type="button"
                                                            data-bs-toggle="collapse" data-bs-target="#flush-collapse0003"
                                                            aria-expanded="false" aria-controls="flush-collapseOne"
                                                            style="background-color: #EFEFEF !important; border-radius: 10px;">
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " readonly value="{{$retchsschutzP->society_PR}}" type="text" name="productR" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " readonly value="" type="text" name="durationR" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <select class="form-select" disabled aria-label="Default select example" name="statusR">
...
{{--                                                                    <option value="Provisionert">Provisionert </option>--}}
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " readonly value="{{$retchsschutzP->last_adjustment_PR}}" type="date" name="modification_dateR" id="" min="1900-01-01" max="9999-12-31">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " readonly value="{{$retchsschutzP->total_commisions_PR}}" type="text" name="provisionR" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " readonly value="" type="text" name="cidR" id="">
                                                            </div>
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$grundversicherungPP->graduation_date_PG}}" type="date" name="graduation_date_PG{{$count}}" id="" min="1900-01-01" max="9999-12-31">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$grundversicherungPP->product_PG}}" type="text" name="product_PG{{$count}}" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <select class="form-select" aria-label="Default select example" name="status_PG{{$count}}">
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$grundversicherungPP->last_adjustment_PG}}" type="date" name="last_adjustment_PG{{$count}}" id="" min="1900-01-01" max="9999-12-31">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$grundversicherungPP->total_commisions_PG}}" type="number" name="total_commisions_PG{{$count}}" id="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$zusatzversicherungPP->graduation_date_PZ}}" type="date" name="graduation_date_PZ{{$count}}" id="" min="1900-01-01" max="9999-12-31">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$zusatzversicherungPP->produkt_PZ}}" type="text" name="produkt_PZ{{$count}}" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$zusatzversicherungPP->vvg_premium_PZ}}"  type="text" name="vvg_premium_PZ{{$count}}" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$zusatzversicherungPP->duration_from_PZ}}" type="date" name="duration_from_PZ{{$count}}" id="from" min="1900-01-01" max="9999-12-31">
                                                                <label for="to">To</label>
                                                                <input class="py-1 form-control " value="{{$zusatzversicherungPP->duration_to_PZ}}" type="date" name="duration_to_PZ{{$count}}" id="to" min="1900-01-01" max="9999-12-31">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <select class="form-select" aria-label="Default select example" name="status_PZ{{$count}}">
                                                                    <option selected value="{{$zusatzversicherungPP->status_PZ}}">{{$zusatzversicherungPP->status_PZ}}</option>
                                                                    <option value="Aufgenomen">Aufgenomen </option>
                                                                    <option value="Offen">Offen</option>
                                                                    <option value="Abgelehnt">Abgelehnt </option>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$zusatzversicherungPP->last_adjustment_PZ}}" type="date" name="last_adjustment_PZ{{$count}}" id="" min="1900-01-01" max="9999-12-31">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$zusatzversicherungPP->provision_PZ}}" type="text" name="provision_PZ{{$count}}" id="">
                                                            </div>
                                                        </div>
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$zusatzversicherungPP->total_commisions_PZ}}" type="number" name="total_commisions_PZ{{$count}}" id="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$retchsschutzP->produkt_PR}}" type="text" name="produkt_PR" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$retchsschutzP->total_commisions_PR}}" type="number" name="total_commisions_PR" id="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$vorsorgeP->production_PV}}" type="text" name="production_PV" id="">
                                                            </div>
                                                        </div>
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$vorsorgeP->total_commisions_PV}}" type="number" name="total_commisions_PV" id="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
