...
<div class="row mt-5 mb-5" class="tasks_8211__">
        ...
        <div class="open-task-box px-4 py-2" style="border: none !important; border-radius: 35px !important;">
            ...
            <div class="header-open-task1" style="background: #f7f7f7; border-bottom-right-radius: 35px !important; border-bottom-left-radius: 35px !important; border-top-left-radius: 35px !important;">
                ...
                <div class="overflow-divvv" style="height: 30vh; overflow: auto; overflow-x: hidden;">
                    ...
                    @endphp
                    <a style="text-decoration: none;color: black" href="{{route('leadfamilyperson',[$taskId,$admin_id])}}">
    ...
    <div class="col-12 col-sm-12 col-md-12 col-lg p-0 m-2 ">
        <div class="open-task-box px-4 py-2" style="border: none !important; border-radius: 35px !important;">
            ...
            <div class=" header-open-task1" style="background: #f7f7f7; border-bottom-right-radius: 35px !important; border-bottom-left-radius: 35px !important; border-top-left-radius: 35px !important;">
                ...
                <hr class="text-black" style="color: #fff !important; height: 2px; margin: 0 !important; opacity: 1;">
                <div style="height: 31vh; overflow: auto; overflow-x: hidden;">
                    @foreach($birthdays as $birth)
                    <div  class="row my-1 mx-3 header-open-task">
                        <div class="col-3 g-0 my-auto">
                            <div class="">
                                <span class="spn-normal">
                                    {{$birth['birthday']}} ({{$birth['age']}})
                ...
                @foreach($personalApp as $perApp)
                    ...
                    <div  class="row my-1 mx-3 header-open-task" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#exampleModal{{$perApp->id}}">
                        <div class="col-3 g-0">
                            <div class="">
                                <span class="spn-normal">
                                   {{$perApp->date}}
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content" style="background: #f8f8f8; border-radius: 43px">
                                            ...
                                            <div class="modal-body p-3">
                                                <div class="row my-2">
                                                    <div class="col-12" >
                                                        <div class=" fw-bold" style="padding: 15px;background-color: #eeeeee;border-radius: 15px">
                                                            Title: {{$perApp->title}}
                                                            <br>
                                            ...
                                            <div class="modal-footer" style="border-top: none !important; display: block;">
                                                <div class="row mx-4 pb-4">
                                                  <div class="col-3 mx-auto">
                                                    <button type="button" class="btn w-100 px-3" style=" color: #ffffff !important; background-color: #6C757D !important;border-radius: 8px !important;" data-bs-dismiss="modal"><b>Close</b></button>
                                                  </div>
    ...
    <div class="col-12 col-sm-12 col-md-12 col-lg-12 my-2">
        <div class="open-task-box px-4 py-2" style="border: none !important; border-radius: 35px !important;">
            ...
            <div class="header-open-task1-pink" style="background: #ffebe5; border-bottom-right-radius: 35px !important; border-bottom-left-radius: 35px !important; border-top-left-radius: 35px !important;">
                ...
                <hr class="text-black" style="color: #fff !important; height: 2px; margin: 0 !important; opacity: 1;">
                <div class="overflow-divvv" style="height: 20vh; overflow: auto;">
                    ...
                    $pend_id = $task->pid;
                    @endphp
                    <div class="row my-1 mx-3 header-open-task-pink"  style="cursor: pointer" data-bs-target="#stats{{$task->pid}}" data-bs-toggle="modal">
                        <div class="col g-0">
                            <div class="">
                                <span class="spn-normal">
                                    21.09.2022
                        ...
                        <div class="col g-0">
                            <div class="ps-5">
                            @if($task->type == "task")
                                <span class="spn-normal text-danger">
                                {{ucfirst($task->type)}}
                                </span>
                                @else
                                <span class="spn-normal text-warning">
Submited
@endif
                                </span>
                            </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content" style="background: #f8f8f8; border-radius: 43px">
                                            ...
                                            <div class="modal-body p-3">
                                                <div class="row">
                                                    <div class="col-6" >
                                                        <div class="text-center my-1 fw-bold" style="padding: 15px;background-color: #eeeeee;border-radius: 15px">
                                                           Datum:
                                                            <br>
                                                       {{$task->created_at}}
                                                        </div>
                                                ...
                                                <div class="row my-2">
                                                    <div class="col-12" >
                                                        <div class="text-center fw-bold" style="padding: 15px;background-color: #eeeeee;border-radius: 15px">
                                                            Beschreibung:
                                                            <br>
                                                            {{$task->description}}
                                                        </div>
                                            ...
                                            <div class="modal-footer text-center" style="border-top: none !important; display: block;">

                                            <button type="button" class="btn px-3" style=" color: #ffffff !important; background-color: #6C757D !important;border-radius: 8px !important;" data-bs-dismiss="modal"><b>Close</b></button>

                                                    <a href="{{route('leadfamilyperson',[$taskId,'admin_id' => $admin_id,'pend_id' => $task->pid])}}"><button type="button" class="btn px-3" style=" color: #ffffff !important; background-color: #6C757D !important;border-radius: 8px !important;" data-bs-dismiss="modal"><b>Open</b></button></a>
                ...
                <div class="collapse2___ pe-3" style="height: 350px; overflow: scroll; overflow-x: hidden;">
                    ...
                    <div style="background: #4EC590; color: #fff; border-radius: 8px; cursor: pointer;">
                        ...
                        <div id="demo{{$taskId}}" class="collapse px-3 py-2">
                            ...
                            <h6 class="m-1"><b>Addressed to:</b> {{\App\Models\Admins::find($task->admin_id)->name}}</h6>
                            <h6 class="m-1"><b>Date & Time:</b> {{$task->updated_at}}</h6>
                            <h6 class="m-1"><b>Description:</b> <span> {{$task->description }}</span></h6>
                            <a href="{{route('leadfamilyperson',['id' => $taskId,'admin_id' => $admin_id,'pend_id' => $pend_id])}}"><button class="btn m-1" style="background-color: #fff; color: #4EC590; font-weight: 600; padding-left: 8%; padding-right: 8%;">Open</button></a>
                        </div>
                        <script>
                ...
                <div class="collapse23___ pe-3" style="height: 350px; overflow: scroll; overflow-x: hidden;">
                    ...
                    <div style="background: #EF696A; color: #fff; border-radius: 8px; cursor: pointer">
                        ...
                        <div id="demo_2{{$authUserId}}" class="collapse px-3 py-2">
                            ...
                            <h6 class="m-1"><b>Date & Time:</b> {{$task->updated_at}}</h6>
                            <h6 class="m-1"><b>Description:</b> <span> {{$task->description}} </span></h6>
                            <a href="{{route('leadfamilyperson',['id' => $taskId,'admin_id' => $admin_id,'pend_id' => $pend_id])}}"><button class="btn m-1" style="background-color: #fff; color: rgb(239, 105, 106); font-weight: 600; padding-left: 8%; padding-right: 8%;">Open</button></a>
