...
<div class="row" id="app">
    ...
    <div class="col">
        <form method="post" enctype="multipart/form-data" id="forma">
            ...
            <input type="hidden" name="newgcount" id="newgcount" value="{{\App\Models\newgegen::where('person_id',$id)->count()}}">
            <input type="hidden" name="newncount" id="newncount" value="{{\App\Models\newnue::where('person_id',$id)->count()}}">
                    ...
                    <div class="row mx-4">
                        <nav class="g-0 nav-form-links">
                            ...
                            <button class="nav-link active col krankenkasse-btn" id="nav-home-tab"
                                        ...
                                        onclick="changecnt(0)">Krankenkasse
                                </button>
                                        ...
                                        <div class="py-2 px-2">
                                            ...
                                            <div class="upload-box mx-1 my-2">
                                                <div class="mx-1 my-2 p-4 text-center">
                                                    ...
                                                    <a href="{{route('showfile',$mandatierturl)}}" target="_blank"><input type="text" class="form-control text-center"
                                                           id="file-input-9c" disabled
                                                           style="background:none; border:none;" value="{{$mandatierturl}}"></a>
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="flush-collapseOne" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body" id="shtogegen"
                                                    ...
                                                    <div id="g{{$gcnt}}">
                                                    <div class="text-end mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-x-circle" viewBox="0 0 16 16" style="cursor:pointer;" onclick="deletethat2('{{$gcnt}}','{{$data->id}}')">
        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
        <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/></svg></div>
                                                            ...
                                                            <div class="upload-box mx-1 my-2">
                                                                <div class="mx-1 my-2 p-4 text-center">
                                                                    ...
                                                                    @if(isset($data->upload_policeFahrzeug))
                                                                        <input type="file" id="file-input-4{{$gcnt}}" name="upload_policeFahrzeug{{$gcnt}}"
                                                                               class="svg-div w-100 border-0  g-0"
                                                                               onchange="upload(this);"
                                                                               value="{{$data->upload_policeFahrzeug}}"
                                                                               >
                                                                        <a style="text-decoration: none" href="{{route('showfile',$data->upload_policeFahrzeug)}}">
                                                                            <input type="text"
                                                                                   class="form-control text-center"
                                                        ...
                                                        <div class="">
                                                            <div class="row mx-2">
                                                                ...
                                                                <div class="col g-0 d-flex justify-content-end">
                                                                    <div class="select-div text-end ">
                                                                        <select name="comparison_type{{$gcnt}}"
                                                                                class="fw-bold" id=""
                                                                                style="background-color: #EFEFEF; font-size: 12px;color:#9F9F9F;">
                                                                            @if(isset($data->comparison_type))
                                                                                <option
                                                                                    value="{{$data->comparison_type}}"
                                                                                    selected>
                                                        ...
                                                        <div class="">
                                                            <div class="mb-3 mt-3">
                                                                ...
                                                                @if(isset($data->commentFahrenzug))
                                                                    <textarea name="commentFahrenzug{{$gcnt}}" class="form-control"
                                                                              id="exampleFormControlTextarea1"
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body"
                                                     style="background-color: #EFEFEF !important; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;" id="shtonew">
                                                    <div class="">
...
{{--                                                                                   name="nationality" type="text" value="{{$data->fahrzeug->nationality}}">--}}
                                                                                <option value="{{$data->fahrzeug->nationality}}" selected>
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <div class="input-select-div mb-2">
                                                                        ...
                                                                        @if(isset($data->fahrzeug->insurance))
                                                                            <input name="insurance" type="text" class="py-1 border-0" value="{{$data->fahrzeug->insurance}}">
                                                                        @else
                                                                    ...
                                                                    <div class="input-select-div mb-2">
                                                                        ...
                                                                        <select name="carried"
                                                                            ...
                                                                            @if(isset($data->fahrzeug->carried))
                                                                                <option value="{{$data->fahrzeug->carried}}" selected>{{$data->fahrzeug->carried}}</option>
 ...
 <div class="" id="n{{$ncnt}}">
 <div class="text-end mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-x-circle" viewBox="0 0 16 16" style="cursor:pointer;" onclick="deletethat('{{$ncnt}}','{{$nue->id}}')">
        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
        <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/></svg></div>
                                                        <div class="row">
                                                            <div
                                                                        ...
                                                                        <div class="upload-box mx-1 my-2">
                                                                            <div class="mx-1 my-2 p-4 text-center">
                                                                                ...
                                                                                @if(isset($nue->vehicle_id))
                                                                                    <input type="file" id="file-input-52{{$ncnt}}"
                                                                                           class="svg-div w-100 border-0  g-0"
                                                                                           onchange="upload(this);"
                                                                                           value="{{$nue->vehicle_id}}"
                                                                                           name="vehicle_id{{$ncnt}}">
                                                                                    <a style="text-decoration: none" href="{{route('showfile',$nue->vehicle_id)}}">
                                                                                        <input type="text"
                                                                                               class="form-control text-center"
                                                                                               id="file-input-52{{$ncnt}}c" disabled
                                                                                               style="background:transparent; border:none;"
                                                                                               value="{{$nue->vehicle_id}}"
                                                                        ...
                                                                        <div class="col">
                                                                            <div class="btn-group w-100"
                                                                                ...
                                                                                @else
                                                                                    <input type="radio"
                                                                                           class="btn-check" value="Ja"
                                                                                           name="leasing{{$ncnt}}" id="btnradio3{{$ncnt}}n"
                                                                                           autocomplete="off">
                                                                                    <label
                                                                                        class="btn btn-outline-secondary w-100 g-0"
                                                                                        value="Ja"
                                                                                    ...
                                                                                    <input type="radio"
                                                                                           class="btn-check"
                                                                                           name="leasing"
                                                                                           value="Nein" id="btnradio4{{$ncnt}}n"
                                                                                           autocomplete="off">
                                                                                    <label
                                                                                        class="btn btn-outline-secondary w-100 g-0 "
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <div class="date-input-div mb-2">
                                                                        ...
                                                                        @if(isset($nue->insurance_date))
                                                                            <input name="insurance_date{{$ncnt}}" type="date"
                                                                                   class="py-1 border-0"
                                                                    ...
                                                                    <div class="input-div1 mb-2">
                                                                        ...
                                                                        @if(isset($nue->km_stood))
                                                                            <input name="km_stood{{$ncnt}}" class="py-1"
                                                                                   type="text"
                                                                                   value="{{$nue->km_stood}}">
                                                                        @else
                                                                            <input name="km_stood{{$ncnt}}" class="py-1"
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <div class="date-input-div mb-2">
                                                                        ...
                                                                        @if(isset($nue->placing_on_the_market))
                                                                            <input name="placing_on_the_market{{$ncnt}}"
                                                                                   type="date" class="py-1 border-0"
                                                                                   value="{{$nue->placing_on_the_market}}">
                                                                        @else
                                                                            <input name="placing_on_the_market{{$ncnt}}"
                                                                    ...
                                                                    <div class="input-select-div mb-2">
                                                                        ...
                                                                        @if(isset($nue->nationality))
                                                                            <input class="py-1 border-0"
                                                                                   name="nationality{{$ncnt}}" type="text" value="{{$nue->nationality}}">

                                                                        @else
                                                                            <input class="py-1 border-0"
                                                                                   name="nationality{{$ncnt}}" type="text">
                                                                        @endif
                                                                    </div>
                                                                    <div class="input-select-div mb-2">
                                                                        <div class="">
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <div class="input-select-div mb-2">
                                                                        ...
                                                                        @if(isset($nue->insurance))
                                                                            <input name="insurance{{$ncnt}}" type="text" class="py-1 border-0" value="{{$nue->insurance}}">
                                                                        @else
                                                                            <input name="insurance{{$ncnt}}" type="text" class="py-1 border-0">
                                                                        @endif
                                                                    </div>
                                                                    <div class="input-select-div mb-2">
                                                                        <div class="">
                                                                    ...
                                                                    <div class="input-select-div mb-2">
                                                                        ...
                                                                        <select name="carried{{$ncnt}}"
                                                                            ...
                                                                            @if(isset($nue->carried))
                                                                                <option value="{{$nue->carried}}" selected>{{$nue->carried}}</option>
                                                                                @for($i=1000;$i<=20000;$i+=1000)
                                                                                    <option value="{{$i}}">{{$i}}</option>
                                                                                @endfor
                                                                            @else
                                                        ...
                                                        <div class="input-select-div mb-2">
                                                            ...
                                                            <select name="employment_relationship"
                                                                ...
                                                                @if(isset($data->things->employment_relationship))
                                                                    <option value="{{$data->things->employment_relationship}}" selected>
                    ...
                    <div class="col g-0 text-center pb-3">
                        ...
                        @if(\App\Models\Pendency::find(Session::get('pend_id'))->completed == 0 && \App\Models\Pendency::find(Session::get('pend_id'))->done == 1 && Auth::user()->hasRole('backoffice'))
                            ...
                            <button class="px-5 py-2" id="submitt1" type="button"
                                    style="border: none; border-radius: 9px; background-color:#285F52;" title="Accept"
                                    onclick="reject();">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fff" class="bi bi-x-circle" viewBox="0 0 16 16">
                                      <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                      <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
                                    </svg>
                            </button>
