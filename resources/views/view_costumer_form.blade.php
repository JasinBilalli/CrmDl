...
<head>
    ...
    <title>View Kundenportfolio</title>
                        ...
                        <nav class="g-0 nav-form-links">
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <button class="nav-link col active status-btn" id="nav-home-tab"
                                        ...
                                        aria-controls="nav-home" aria-selected="true" onclick="changecnt(0)"><span class="desk-t">Status</span><span class="mobile-t">S</span><div><span class="mobile-t" style="font-size: 10px;">Status</span></div>
                                </button>
                                <button class="nav-link col auto-btn" id="nav-profile-tab" data-bs-toggle="tab"
                                        data-bs-target="#nav-profile" type="button" role="tab"
                                        aria-controls="nav-profile" aria-selected="false"
                                        onclick="changecnt(1)"><span class="desk-t">Angaben</span><span class="mobile-t">A</span><div><span class="mobile-t" style="font-size: 10px;">Angaben</span></div>
                                </button>
                                                        ...
                                                        <div class="upload-box p-3">
                                                            <div class="mb-2">
                                                                <div
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        type="text" name="societyG"
                                                                        readonly value="{{$grundversicherungPP->society_PG}}"
                                                                        id="">
                                                                </div>
                                                            </div>
                                                            <div class="mb-2">
                                                            ...
                                                            <div class="mb-2">
                                                                <div
                                                                    ...
                                                                    <input type="text" class="form-control transparent-styling" value="{{$grundversicherungPP->status_PG}}" readonly>
                                                                </div>
                                                            ...
                                                            <div class="mb-2">
                                                                <div
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        value="{{$grundversicherungPP->total_commisions_PG}}"
                                                        ...
                                                        <div class="upload-box p-3">
                                                            <div class="mb-2">
                                                                <div
                                                                    ...
                                                                    <input
                                                                        class="py-1 form-control transparent-styling fw-600"
                                                                        value="{{$vorsorgeP->society_PV}}" type="text"
                                                            ...
                                                            <div class="mb-2">
                                                                <div
                                                                    ...
                                                                    <input type="text" class="form-control transparent-styling" value="{{$vorsorgeP->status_PV}}" readonly>
                                                                </div>
                                                            ...
                                                            <div class="mb-2">
                                                                <div
                                                                    ...
                                                                    <input
                                                                        class="py-1 form-control transparent-styling fw-bold"
                                                                        value="{{$vorsorgeP->total_commisions_PV}}" readonly
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="upload-box p-3">
                                                            <div class="mb-2">
                                                                <div
                                                                    ...
                                                                    <input
                                                                        class="py-1 form-control transparent-styling fw-600"
                                                                        value="{{$zusatzversicherungPP->society_PZ}}"
                                                            ...
                                                            <div class="mb-2">
                                                                <div
                                                                    ...
                                                                    <input type="text" class="form-control transparent-styling" value="{{$zusatzversicherungPP->status_PZ}}" readonly>
                                                                </div>
                                                            ...
                                                            <div class="mb-2">
                                                                <div
                                                                    ...
                                                                    <input
                                                                        class="py-1 form-control transparent-styling fw-600"
                                                                        disabled readonly
                                                                        value="{{$zusatzversicherungPP->last_adjustment_PZ}}"
                                                            ...
                                                            <div class="mb-2">
                                                                <div
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        value="{{$zusatzversicherungPP->total_commisions_PZ}}"
                                                        ...
                                                        <div class="mb-2">
                                                            <div
                                                                ...
                                                                <input class="py-1 form-control "
                                                                       value=""
                                                                       type="text" readonly name="cidZ" id="">
                                                            </div>
                                                        ...
                                                        <div class="upload-box p-3">
                                                            <div class="mb-2">
                                                                <div
                                                                    ...
                                                                    <input
                                                                        class="py-1 form-control transparent-styling fw-600"
                                                                        value="{{$hausratP->society_PH}}" type="text"
                                                            ...
                                                            <div class="mb-2">
                                                                <div
                                                                    ...
                                                                    <input type="text" class="form-control transparent-styling" value="{{$hausratP->status_PH}}" readonly>
                                                                </div>
                                                            ...
                                                            <div class="mb-2">
                                                                <div
                                                                    ...
                                                                    <input
                                                                        class="py-1 form-control transparent-styling fw-bold"
                                                                        value="{{$hausratP->total_commisions_PH}}" type="text"
                                                        ...
                                                        <div class="upload-box p-3">
                                                            <div class="mb-2">
                                                                <div
                                                                    ...
                                                                    <input
                                                                        class="py-1 form-control transparent-styling fw-600"
                                                                        value="{{$retchsschutzP->society_PR}}" readonly
                                                            ...
                                                            <div class="mb-2">
                                                                <div
                                                                    ...
                                                                    <input type="text" class="form-control transparent-styling" value="{{$retchsschutzP->status_PR}}" readonly>
                                                                </div>
                                                            ...
                                                            <div class="mb-2">
                                                                <div
                                                                    ...
                                                                    <input
                                                                        class="py-1 form-control transparent-styling fw-bold"
                                                                        value="{{$retchsschutzP->total_commisions_PR}}"
                            ...
                            <div class="text-center mt-3 pb-3">
                                <div class="row">
                                    <div class="col g-0 text-end my-auto">
                                        <div class="" onclick="nextonee()" style="cursor:pointer;">
                            ...
                            <div class="row  mx-2 mx-sm-4">
                                ...
                                <div class="text-center mt-3 pb-3">
                                    <div class="row">
                                        <div class="col g-0 text-end my-auto">
                                            <div class="">
                                        <span class="pe-2" style="color: #9F9F9F; cursor: pointer;" onclick="nextonee()">
                                            Uberspringen
                                        </span>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="accordion-body no-padding-form"
                                                        ...
                                                        <div class="upload-box p-3">
                                                            <div class="mb-2">
                                                                <div
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        value="{{$grundversicherungPP->graduation_date_PG}}"
                                                            ...
                                                            <div class="mb-2">
                                                                <div
                                                                    ...
                                                                    <input
                                                                        class="py-1 form-control transparent-styling "
                                                                        value="{{$grundversicherungPP->society_PG}}"
                                                            ...
                                                            <div class="mb-2">
                                                                <div
                                                                    ...
                                                                    <input
                                                                        class="py-1 form-control transparent-styling "
                                                                        value="{{$grundversicherungPP->product_PG}}"
                                                        ...
                                                        <div class="mb-2">
                                                            <div
                                                                ...
                                                                @if($grundversicherungPP->status_PG == 'Aufgenomen')
                                                                    <input type="text" class="form-control transparent-styling colori-green fw-bold" value="{{$grundversicherungPP->status_PG}}" readonly>
                                                                @elseif($grundversicherungPP->status_PG == 'Offen')
                                                                    <input type="text" class="form-control transparent-styling text-warning fw-bold" value="{{$grundversicherungPP->status_PG}}" readonly>
                                                                @elseif($grundversicherungPP->status_PG == 'Provisionert')
                                                                    <input type="text" class="form-control transparent-styling text-success fw-bold" value="{{$grundversicherungPP->status_PG}}" readonly>
                                                                @elseif($grundversicherungPP->status_PG == 'notselected')
                                                                    <input type="text" class="form-control transparent-styling text-secondary fw-bold" value="{{$grundversicherungPP->status_PG}}" readonly>
                                                                @elseif($grundversicherungPP->status_PG == 'Zuruckgezogen')
                                                                    <input type="text" class="form-control transparent-styling text-secondary fw-bold" value="{{$grundversicherungPP->status_PG}}" readonly>
                                                                @elseif($grundversicherungPP->status_PG == 'Abgelehnt')
                                                                    <input type="text" class="form-control transparent-styling text-danger fw-bold" value="{{$grundversicherungPP->status_PG}}" readonly>
                                                                @endif
                                                            </div>
                                                        ...
                                                        <div class="mb-2">
                                                            <div
                                                                ...
                                                                <input class="py-1 form-control transparent-styling fs-4 fw-bold colori-green"
                                                                       value="{{$grundversicherungPP->total_commisions_PG}} CHF"
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-2">
                                                            <div
                                                                ...
                                                                @elseif($autoversicherungP->status_PA == 'Zuruckgezogen')
                                                                    <input type="text" class="form-control transparent-styling text-secondary fw-bold" value="{{$autoversicherungP->status_PA}}" readonly>
                                                                @elseif($autoversicherungP->status_PA == 'Abgelehnt')
                                                                    <input type="text" class="form-control transparent-styling text-danger fw-bold" value="{{$autoversicherungP->status_PA}}" readonly>
                                                    ...
                                                    <div class="accordion-body no-padding-form"
                                                        ...
                                                        <div class="mb-2">
                                                            <div
                                                                ...
                                                                <input
                                                                    class="py-1 form-control transparent-styling fw-600"
                                                                    value="{{$zusatzversicherungPP->graduation_date_PZ}}"
                                                                    disabled readonly type="date"
                                                        ...
                                                        <div class="upload-box p-3">
                                                            <div class="mb-2">
                                                                <div
                                                                    ...
                                                                    <input
                                                                        class="py-1 form-control transparent-styling"
                                                                        value="{{$zusatzversicherungPP->produkt_PZ}}"
                                                            ...
                                                            <div class="mb-2">
                                                                <div
                                                                    ...
                                                                    <input
                                                                        class="py-1 form-control transparent-styling"
                                                                        value="{{$zusatzversicherungPP->vvg_premium_PZ}}"
                                                            ...
                                                            <div class="mb-2">
                                                                <div
                                                                    ...
                                                                    @if($zusatzversicherungPP->status_PZ == 'Aufgenomen')
                                                                        <input type="text" class="form-control transparent-styling colori-green fw-bold" value="{{$zusatzversicherungPP->status_PZ}}" readonly>
                                                                    @elseif($zusatzversicherungPP->status_PZ == 'Offen')
                                                                        <input type="text" class="form-control transparent-styling text-warning fw-bold" value="{{$zusatzversicherungPP->status_PZ}}" readonly>
                                                                    @elseif($zusatzversicherungPP->status_PZ == 'Provisionert')
                                                                        <input type="text" class="form-control transparent-styling text-success fw-bold" value="{{$zusatzversicherungPP->status_PZ}}" readonly>
                                                                    @elseif($zusatzversicherungPP->status_PZ == 'notselected')
                                                                        <input type="text" class="form-control transparent-styling text-secondary fw-bold" value="{{$zusatzversicherungPP->status_PZ}}" readonly>
                                                                    @elseif($zusatzversicherungPP->status_PZ == 'Zuruckgezogen')
                                                                        <input type="text" class="form-control transparent-styling text-secondary fw-bold" value="{{$zusatzversicherungPP->status_PZ}}" readonly>
                                                                    @elseif($zusatzversicherungPP->status_PZ == 'Abgelehnt')
                                                                        <input type="text" class="form-control transparent-styling text-danger fw-bold" value="{{$zusatzversicherungPP->status_PZ}}" readonly>
                                                            ...
                                                            <div class="mb-2">
                                                                <div
                                                                    ...
                                                                    <input
                                                                        class="py-1 form-control transparent-styling"
                                                                        value="{{$zusatzversicherungPP->provision_PZ}}"
                                                        ...
                                                        <div class="mb-2">
                                                            <div
                                                                ...
                                                                <input class="py-1 form-control transparent-styling fs-4 fw-bold colori-green"
                                                                       value="{{$zusatzversicherungPP->total_commisions_PZ}} CHF"
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-2">
                                                            <div
                                                                ...
                                                                @elseif($hausratP->status_PH == 'Zuruckgezogen')
                                                                    <input type="text" class="form-control transparent-styling text-secondary fw-bold" value="{{$hausratP->status_PH}}" readonly>
                                                                @elseif($hausratP->status_PH == 'Abgelehnt')
                                                                    <input type="text" class="form-control transparent-styling text-danger fw-bold" value="{{$hausratP->status_PH}}" readonly>
                                                                @endif
                                                            </div>
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-2">
                                                            <div
                                                                ...
                                                                @elseif($retchsschutzP->status_PR == 'Zuruckgezogen')
                                                                    <input type="text" class="form-control transparent-styling text-secondary fw-bold" value="{{$retchsschutzP->status_PR}}" readonly>
                                                                @elseif($retchsschutzP->status_PR == 'Abgelehnt')
                                                                    <input type="text" class="form-control transparent-styling text-danger fw-bold" value="{{$retchsschutzP->status_PR}}" readonly>
                                                                @endif
                                                            </div>
                                                    ...
                                                    <div class="accordion-body no-padding-form"
                                                        ...
                                                        <div class="mb-2">
                                                            <div
                                                                ...
                                                                @elseif($vorsorgeP->status_PV == 'Zuruckgezogen')
                                                                    <input type="text" class="form-control transparent-styling text-secondary fw-bold" value="{{$vorsorgeP->status_PV}}" readonly>
                                                                @elseif($vorsorgeP->status_PV == 'Abgelehnt')
                                                                    <input type="text" class="form-control transparent-styling text-danger fw-bold" value="{{$vorsorgeP->status_PV}}" readonly>
                                                                @endif
                                                            </div>
                                                        </div>
                                                        <div class="mb-2">
