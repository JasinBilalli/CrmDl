                                        ...
                                        <div class="added-content" id="added-content1" style="display: none;">
                                            <div class="to-do-content mb-2 p-4"
                                                ...
                                                <div class="py-2">
                                                    ...
                                                    <textarea class="form-control" id="description1" rows="4"></textarea>
                                                </div>
                                                <div class="py-2 d-flex justify-content-between">
                                                    ...
                                                    <button @click="asign" onclick="saveContentFunct1()" type="button" class="btn col-auto  text-white  rounded" id="save-btn"
